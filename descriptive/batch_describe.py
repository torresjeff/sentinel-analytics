...
if __name__ == '__main__':
    ...
    # TODO: mostrar un map(?) de cuales regiones son mas AFECTADAS por corrupcion. Esto sería el gráfico, pero buscando municipios/departamentos/pais en vez de cualquier palabra asociada
